  ...
  return (
    <>
      ...
      <div className="container">
        ...
        <div className="forms">
          <p className="mb-4 text-[#8A8A8A]">Create your own custom tour, and if an Avatar finds it appealing, they’ll accept your offer and guide you through your personalized experience.</p>
          <form onSubmit={handleSubmit(onSubmit)} noValidate>
            <div className="flex gap-2 lg:flex-col lg:gap-0">
              <div className="mb-2 flex-1">
                ...
                <input type="text" name="Title" id="Title" placeholder="Enter the Offer Title" className="input my-1" {...register("Title")} />
