      ...
      {location.pathname === `/user/booking/${params?.id}` && (
        <div className="fixed flex items-end justify-center inset-0 bg-black bg-opacity-50 z-[99]">
          ...
          >
            ...
            <div className="flex justify-center py-5 text-center text-[#ABABAB] sm:text-sm">
              The Avatar is already booked for this specific date and time slot.
              Please try the next time slot available on this date
            </div>
