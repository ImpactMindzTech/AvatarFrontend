      ...
      <div className="fixed  flex items-end justify-center inset-0 bg-black bg-opacity-50 z-[99]">
        ...
        >
          ...
          <div className="flex justify-center py-5">
            <p className="text-grey-800 text-center sm:text-sm">
              Are you sure want to delete your Avathon for{" "}
              <b className="text-grey-900">{data?.avathonTitle}?</b>
            </p>
          </div>
...
export default DeleteAvathonsModal;
