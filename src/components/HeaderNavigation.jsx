 ...
 const totalprofile =getLocalStorage("user").totalRoles || getLocalStorage("user").totalprofile;
  ...
  >
    ...
    {role === "user" ? "Switch Avatar" : "Switch User"}
                ...
                <div className="my-2">
                <Link to ="/user/Bugreport">
                <SheetTrigger className="w-full" >
                    <button  className={`py-3 px-10 pl-[54px] w-full text-left relative font-semibold before:content-[''] before:absolute before:w-[4px] before:h-[100%] before:bg-[#2d2d2d]/[0] before:top-[0px] before:left-[0px] ${
                          isActive("/user/Bugreport")
                            ? "bg-gradient-to-r from-[#000000]/[0.13] to-[transparent] text-[#2d2d2d] before:bg-[#2d2d2d]/[1]"
                            : "bg-[#ffffff] text-[#ababab]"
                        }`}>
                      <img
  ...
  >
    ...
    {role === "user" ? "Switch Avatar" : "Switch User"}
                ...
                <div className="my-2">
                <Link to ="/avatar/Bugreport">
                <SheetTrigger className="w-full" >
                    <button  className={`py-3 px-10 pl-[54px] w-full text-left relative font-semibold before:content-[''] before:absolute before:w-[4px] before:h-[100%] before:bg-[#2d2d2d]/[0] before:top-[0px] before:left-[0px] ${
                          isActive("/avatar/Bugreport")
                            ? "bg-gradient-to-r from-[#000000]/[0.13] to-[transparent] text-[#2d2d2d] before:bg-[#2d2d2d]/[1]"
                            : "bg-[#ffffff] text-[#ababab]"
                        }`}>
                      <img
